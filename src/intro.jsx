...
export default function Intro({ onComplete }) {
  ...
  // ── 4 typewriter lines, no divider ──────────────────────────────────────────
  const onTW1 = () => setTimeout(() => setTwLine(2), 700);
  const onTW2 = () => setTimeout(() => setTwLine(3), 700);
  const onTW3 = () => setTimeout(() => setTwLine(4), 800);
  const onTW4 = () => setTimeout(() => setShowCTA(true), 800);
    ...
    <>
      ...
      >
        ...
        {hasStarted && scene === 4 && (
          ...
          >
            <ParticleCanvas active={twLine > 0 && twLine < 5} />
